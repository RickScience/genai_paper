...
The study by Ouyang et al. (2022) aims to align the behavior of large language models with human intentions, overcoming the limitations of traditional training methods based solely on next-token prediction. To achieve this, the authors apply the RLHF (Reinforcement Learning from Human Feedback) technique, integrating human demonstrations and preferences into the fine-tuning process.

Furthermore, the study seeks to demonstrate that alignment may be more effective than simply increasing model scale. In the comparison between InstructGPT (1.3B parameters) and the standard GPT-3 model (175B parameters), the smaller but aligned model was consistently preferred by human evaluators. Based on these findings, the authors propose a new paradigm for LLM development: to prioritize alignment over scale, focusing on usefulness, truthfulness, and safety.
...
## 3. The Three-Step InstructGPT Training Methodology
...
### 3.3. Step 3: Reinforcement Learning from Human Feedback (RLHF)
...
### 4.1. Dominance in Human Preference Evaluations
...
### 4.2. Improvements in Truthfulness and Safety
...
### 4.3. Mitigating the "Alignment Tax"
...
### 5.1. Identified Limitations and Remaining Failures
...
### 5.2. Implications for AI Alignment Research
...
### 5.3. The Challenge of Value Representation: "Whose Preferences?"
